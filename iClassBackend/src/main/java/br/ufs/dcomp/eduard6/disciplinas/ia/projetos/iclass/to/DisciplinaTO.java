...
public class DisciplinaTO extends TransferObjectBase {
	...
	public boolean equals(Object obj) {
		if (obj instanceof DisciplinaTO) {
			DisciplinaTO disciplinaTO = (DisciplinaTO) obj;
			if (this.codigo != null && disciplinaTO.getCodigo() != null)
				return this.codigo.toLowerCase().equals(disciplinaTO.getCodigo().toLowerCase());
		}
		return false;
	}
